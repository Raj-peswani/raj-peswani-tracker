...
export default function QuantDashboard({ initialAnalysis }: { initialAnalysis: QuantAnalysis }) {
  ...
  return (
    <main>
      <header className="sticky top-0 z-50 isolate border-b border-[#dcddd7] bg-[#f7f8f4]/90 backdrop-blur-xl"><div className="mx-auto flex max-w-[1500px] items-center justify-between px-5 py-3 sm:px-8"><Link href="/" className="flex items-center gap-3"><span className="grid h-8 w-8 place-items-center rounded-full bg-[#20231f] text-xs font-bold text-white">RP</span><span className="hidden text-sm font-semibold tracking-tight sm:block">Raj Peswani&apos;s Tracker</span></Link><nav className="flex items-center gap-1 overflow-x-auto rounded-full border border-[#d9dbd4] bg-white p-1 text-[10px] font-semibold sm:text-xs"><Link href="/" className="rounded-full px-2.5 py-2 text-[#666c63] sm:px-4">News</Link><Link href="/stocks" className="rounded-full px-2.5 py-2 text-[#666c63] sm:px-4">Stocks</Link><Link href="/market-bets" className="whitespace-nowrap rounded-full px-2.5 py-2 text-[#666c63] sm:px-4">Market Bets</Link><span className="rounded-full bg-[#20231f] px-2.5 py-2 text-white sm:px-4">Quant</span><Link href="/lookouts" className="rounded-full px-2.5 py-2 text-[#666c63] sm:px-4">Lookouts</Link><Link href="/strong-buys" className="whitespace-nowrap rounded-full px-2.5 py-2 text-[#666c63] sm:px-4">Strong Buys</Link></nav><span className="hidden font-mono text-[9px] uppercase tracking-[0.14em] text-[#858b81] md:block">Swing lab</span></div></header>
